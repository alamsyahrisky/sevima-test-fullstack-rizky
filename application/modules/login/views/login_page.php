                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post" onsubmit="return ajax_action_login();">
                                ...
                                <button id="btn-login" class="au-btn au-btn--block btn-primary m-b-20" type="submit">Sign
                                    in</button>
                        ...
                        <div class="login-form">
                            ...
                            <form method="post" id="form-add" onsubmit="return ajax_action_add();">
                                ...
                                <button onclick="$('#form-login').fadeIn(); $('#form-register').hide();"
                                    class="au-btn au-btn--block btn-primary m-b-20" type="button">Back sign in</button>
                            </form>
                        </div>
                    </div>
                </div>
